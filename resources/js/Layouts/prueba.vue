...
<div>
    ...
    <div class="zmin-h-screen bg-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('agendar.index')" :active="route().current('agendar.index')">
                                <!--
                                Agedar
                            </jet-nav-link>
                            <jet-nav-link :href="route('administrar.index')" :active="route().current('administrar.index')">
                                <!--
                                Administrar
                            </jet-nav-link>
                        </div>
        ...
        <!-- Page Content -->
        <v-navigation-drawer v-model="drawer" absolute color="grey lighten-3"  permanent
          expand-on-hover>
          <v-list>
